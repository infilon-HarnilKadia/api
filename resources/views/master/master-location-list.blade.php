    ...
    <div class="page-content-wrapper-inner">
        ...
        <div class="content-viewport">
            <div class="row">
                <div class="col-lg-12">
                    <div class="grid">
                        <p class="grid-header">Location Master</p>
                        <div class="item-wrapper">
                            <div class="text-left pl-3 pb-2 clearfix">
                                <a href="{{url('master-location/add')}}" class="btn btn-sm btn-primary btn-icon"><i class="mdi mdi-plus"></i>Add</a>
                                ...
                                <table class="table search" id="gmm-table">
                                    <thead>
                                        ...
                                        ?>
                                            ...
                                            <th>Location</th>
                                            <?php } ?>
                                            <?php if(in_array('country', $mth)){ ?>
                                            <th>Country</th>
                                            <?php } ?>
                                            <?php if(in_array('kilometers from dar', $mth)){ ?>
                                            <th>Kilometers From Dar</th>
                                            <?php } ?>
                                    ...
                                    if(count($data)) {
                                        ...
                                        <tr>
                                            ...
                                            <?php } ?>                        
                                            <?php if(in_array('edit', $mth)){ ?>
                                            <td><a href="{{ url('master-location/edit/'.enc(1,$d['id'])) }}"><i class="mdi mdi-border-color"></i></a></td>
                                            <?php } ?>
                                            <?php if(in_array('delete', $mth)){ ?>
                                            <td><a href="{{url('master-location/delete') }}/{{enc(1,$d['id'])}}" onClick="return confirm('Are you sure to delete?')"><i class="mdi mdi-delete"></i></a></td>
                                            <?php } ?>
                                        </tr>
                                        <?php
                                        }
