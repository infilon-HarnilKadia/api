    ...
    <div class="page-content-wrapper-inner">
        ...
        <div class="content-viewport">
            <div class="row">
                <div class="col-lg-12">
                    <div class="grid">
                        <p class="grid-header">Account</p>
                        <div class="item-wrapper">
                            <div class="text-left pl-3 pb-2 clearfix">
                                <a href="{{ url('accounts/add/1') }}" class="btn btn-sm btn-primary btn-icon"><i
                                        class="mdi mdi-plus"></i>Create Invoice</a>
                                <a href="{{ url('accounts/add/2') }}" class="btn btn-sm btn-primary btn-icon"><i
                                        class="mdi mdi-plus"></i>Create Pro Forma Invoice</a>
                            ...
                            <div class="data-responsive">
                                <table class="table search" id="gmm-ajax-table"
                                    data-url="{{ url('accounts/ajax-data') }}"
                                    data-order="[[ 1, &quot;desc&quot; ]]">
                                    <thead>
