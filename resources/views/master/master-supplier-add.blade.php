        ...
        <div class="viewport-header">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb has-arrow">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('master-supplier') }}">Supplier Master</a></li>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="content-viewport">
                    <form action="{{ url('master-supplier/save') }}" method="post">
                        @csrf
                        @if(isset($id))
                        <input type="hidden" name="id" value="{{$id}}">
                        @endif
                        <div class="grid">
                            <p class="grid-header"><?php echo isset($result)?'Edit':'Add'; ?> Supplier</p>
                            <div class="grid-body">
                                <div class="item-wrapper">
                                    ...
                                    <a href="{{url('master-supplier')}}" class="btn btn-sm btn-danger btn-icon"><i class="mdi mdi-close"></i>Cancel</a>
                                </div>
                            </div>
                        </div>
                    </form>
